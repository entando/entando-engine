...
public class WidgetTypeDOM {
    ...
    private static final String TAB_PARAMETER = "parameter";
     ...
     * @throws ApsSystemException In caso di errore nell'interpretazione dell'xml di configurazione.
     */
    ...
    /**
     * Restituisce la lista (in oggetti WidgetTypeParameter) di parametri di configurazione della showlet.
     *
