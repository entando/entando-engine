...
public class LocalStorageManagerInterface implements IApiExportable {
    ...
    public List<LinkedListItem> getListDirectory(Properties properties) throws Throwable {
        ...
        try {
            ...
            if (!StorageManagerUtil.isValidDirName(pathValue)) {
                throw new ApiException(IApiErrorCodes.API_VALIDATION_ERROR, "The path '" + pathValue + "' does not exists",
        ...
        try {
            ...
            if (storageResource.isDirectory()) {
                ...
                this.getStorageManager()
                        .saveFile(storageResource.getName(), isProtected, new ByteArrayInputStream(storageResource.getBase64()));
            }
        } catch (ApiException ae) {
    ...
    public String getApiResourceURLWithParams(Properties properties, BasicFileAttributeView fileAttributeView, String path,
            boolean isProtected) throws Throwable {
