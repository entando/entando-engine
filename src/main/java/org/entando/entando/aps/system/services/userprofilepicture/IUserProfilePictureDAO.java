...
/**
 * The interface for user profile picture DAO.
 *
 * @author b.queiroz
 */
public interface IUserProfilePictureDAO {
     ...
     */
    UserProfilePicture loadUserProfilePicture(String username) throws EntException;
     ...
     *
     * @param username the username which will have its user profile picture deleted
     * @throws EntException the ent exception
     */
