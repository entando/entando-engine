...
@XmlType(propOrder = {"code", "titles", "pluginCode", "mainGroup", "typeParameters", "action", "parentTypeCode", "config", "locked", "gui",
        "fragments"})
    ...
    public WidgetType getModifiedWidgetType(IWidgetTypeManager widgetTypeManager) throws ApiException {
        ...
        if (type.isLogic()) {
            ...
            if (null != parameters && !parameters.isEmpty()) {
                ...
                //type.setTypeParameters(parameters);
                //type.setAction("configSimpleParameter");
                throw new ApiException(IApiErrorCodes.API_VALIDATION_ERROR, "Parameters of existing widget mustn't been changed",
