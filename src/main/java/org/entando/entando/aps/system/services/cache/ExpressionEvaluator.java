 ...
 *
 * Evaluation context class that adds a method parameters as SpEL variables, in a lazy manner. The lazy nature eliminates unneeded parsing
 * of classes byte code for parameter discovery.
 *
 * @author Costin Leau
 * @author Phillip Webb
 * @since 3.1
...
class ExpressionEvaluator {
     ...
     * @param result the return value (can be {@code null}) or {@link #NO_RESULT} if there is no return at this time
