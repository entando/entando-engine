...
public class FilterUtils extends BaseFilterUtils {
    ...
    public static List<UserFilterOptionBean> getUserFilters(String userFiltersParam,
        ...
        for (int i = 0; i < filterStrings.length; i++) {
            ...
            try {
                ...
                UserFilterOptionBean filterBean = new UserFilterOptionBean(properties, prototype, currentFrame, currentLang, dateFormat,
                        request);
                list.add(filterBean);
            } catch (Throwable t) {
    ...
    /**
     * Crea il parametro di configurazione della showlet, caratteristico per la rappresentazione dei filtri. Il parametro viene ricavato in
     * base alla lista di properties specificata.
     *
    ...
    public UserFilterOptionBean getUserFilter(String dataObjectType,
        ...
        return this.getUserFilter(dataObjectType, bean, dataObjectManager, "dd/MM/yyyy", reqCtx);
    }

    /**
     * @deprecated From Entando 3.0 version 3.2.0. Use getUserFilter(String contentType, IEntityFilterBean, IContentManager, String,
    ...
    /**
     * Crea il parametro di configurazione della showlet, caratteristico per la rappresentazione dei filtri. Il parametro viene ricavato in
     * base alla lista di filtri specificati.
     *
