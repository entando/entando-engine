...
public interface IUserProfile extends IApsEntity {
    ...
    /**
     * Returns the value of an attribute identified by his key. The value can be of any type.
     *
    ...
    Object getValueByRole(String rolename);
    ...
    void setPublicProfile(boolean isPublic);
