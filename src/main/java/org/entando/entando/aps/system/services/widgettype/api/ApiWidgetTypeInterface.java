...
public class ApiWidgetTypeInterface implements IApiExportable {
    ...
    public JAXBWidgetType getWidgetType(Properties properties) throws Throwable {
    ...
    public void addWidgetType(JAXBWidgetType jaxbWidgetType) throws Throwable {
    ...
    public StringApiResponse updateWidgetType(JAXBWidgetType jaxbWidgetType) throws Throwable {
    ...
    public void deleteWidgetType(Properties properties) throws Throwable {
