...
public class UserProfileDAO extends AbstractEntityDAO implements IUserProfileDAO {
    ...
    private static final String ADD_PROFILE_SEARCH_RECORD =
            "INSERT INTO authuserprofilesearch " +
                    "(username, attrname, textvalue, datevalue, numvalue, langcode) " +
                    "VALUES ( ? , ? , ? , ? , ? , ? ) ";
    private static final String DELETE_PROFILE_SEARCH_RECORD =
            "DELETE FROM authuserprofilesearch WHERE username = ? ";
    private static final String GET_ALL_ENTITY_ID =
    ...
    private static final String DELETE_PROFILE_BY_USER =
            "DELETE FROM authuserprofiles WHERE username = ? ";
    private static final String GET_PROFILE_VO =
    ...
    private static final String DELETE_ATTRIBUTE_ROLE_RECORD =
