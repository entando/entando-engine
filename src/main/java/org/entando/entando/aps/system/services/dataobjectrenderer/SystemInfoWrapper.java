...
public class SystemInfoWrapper {
    ...
    public IPage getPageWithWidget(String widgetCode) {
        IPage page = null;
        try {
            IPageManager pageManager = (IPageManager) ApsWebApplicationUtils
                    .getBean(SystemConstants.PAGE_MANAGER, this.getReqCtx().getRequest());
    ...
    public String getPageURLWithWidget(String widgetCode) {
        ...
        try {
            ...
            IURLManager urlManager = (IURLManager) ApsWebApplicationUtils
                    .getBean(SystemConstants.URL_MANAGER, this.getReqCtx().getRequest());
