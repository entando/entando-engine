...
/**
 * User Profile tag. Return an attribute value of an user profile.
 *
 * @author E.Santoboni
 */
public class UserProfileAttributeTag extends ExtendedTagSupport {
    ...
    protected IUserProfile getUserProfile() throws Throwable {
        IUserProfileManager userProfileManager = (IUserProfileManager) ApsWebApplicationUtils
                .getBean(SystemConstants.USER_PROFILE_MANAGER, this.pageContext);
