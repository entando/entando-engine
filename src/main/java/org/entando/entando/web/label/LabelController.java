...
public class LabelController {
    ...
    public ResponseEntity<SimpleRestResponse<LabelDto>> updateLabelGroup(@PathVariable String labelCode,
            @Valid @RequestBody LabelRequest labelRequest, BindingResult bindingResult) {
