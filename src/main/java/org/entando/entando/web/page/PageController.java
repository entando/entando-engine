...
public class PageController {
    ...
    public ResponseEntity<RestResponse<List<PageDto>, Map<String, String>>> getPages(@ModelAttribute("user") UserDetails user,
    ...
    public ResponseEntity<PagedRestResponse<PageDto>> getFreeOnlinePages(@ModelAttribute("user") UserDetails user,
    ...
    public ResponseEntity<RestResponse<PageDto, Map<String, String>>> getPage(@ModelAttribute("user") UserDetails user,
    ...
    public ResponseEntity<RestResponse<PageDto, Map<String, String>>> updatePage(@ModelAttribute("user") UserDetails user,
            @PathVariable String pageCode, @Valid @RequestBody PageRequest pageRequest, BindingResult bindingResult) {
    ...
    public ResponseEntity<RestResponse<PageDto, Map<String, String>>> updatePageStatus(@ModelAttribute("user") UserDetails user,
            @PathVariable String pageCode, @Valid @RequestBody PageStatusRequest pageStatusRequest, BindingResult bindingResult) {
    ...
    public ResponseEntity<SimpleRestResponse<PageDto>> addPage(@ModelAttribute("user") UserDetails user,
            @Valid @RequestBody PageRequest pageRequest, BindingResult bindingResult) throws ApsSystemException {
    ...
    public ResponseEntity<SimpleRestResponse<?>> deletePage(@ModelAttribute("user") UserDetails user, @PathVariable String pageCode)
    ...
    public ResponseEntity<SimpleRestResponse<PageDto>> movePage(@ModelAttribute("user") UserDetails user, @PathVariable String pageCode,
            @Valid @RequestBody PagePositionRequest pageRequest, BindingResult bindingResult) {
    ...
    @RestAccessControl(permission = Permission.SUPERUSER)
    @RequestMapping(value = "/pages/{pageCode}/references/{manager}", method = RequestMethod.GET, produces =
            MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<PagedRestResponse<?>> getPageReferences(@PathVariable String pageCode, @PathVariable String manager,
    ...
    @RestAccessControl(permission = Permission.MANAGE_PAGES)
    @RequestMapping(value = "/pages/{pageCode}", method = RequestMethod.PATCH, produces = MediaType.APPLICATION_JSON_VALUE, consumes =
            "application/json-patch+json")
    public ResponseEntity<RestResponse<PageDto, Map<String, String>>> patchPage(@ModelAttribute("user") UserDetails user,
            @PathVariable String pageCode, @RequestBody JsonNode patchRequest, BindingResult bindingResult) {
