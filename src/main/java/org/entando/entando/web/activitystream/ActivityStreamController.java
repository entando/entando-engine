...
public class ActivityStreamController {
    ...
    public ResponseEntity<PagedRestResponse<ActionLogRecordDto>> getActivityStream(RestListRequest requestList, HttpServletRequest request)
            throws JsonProcessingException {
        this.getActivityStreamValidator().validateRestListRequest(requestList, ActionLogRecordDto.class);
        PagedMetadata<ActionLogRecordDto> result = this.getActivityStreamService()
                .getActivityStream(requestList, (UserDetails) request.getSession().getAttribute("user"));
    ...
    public ResponseEntity<SimpleRestResponse<ActionLogRecordDto>> addLike(@PathVariable int recordId, HttpServletRequest request)
            throws JsonProcessingException {
        ActionLogRecordDto result = this.getActivityStreamService()
                .addLike(recordId, (UserDetails) request.getSession().getAttribute("user"));
    ...
    public ResponseEntity<SimpleRestResponse<ActionLogRecordDto>> removeLike(@PathVariable int recordId, HttpServletRequest request)
            throws JsonProcessingException {
        ActionLogRecordDto result = this.getActivityStreamService()
                .removeLike(recordId, (UserDetails) request.getSession().getAttribute("user"));
    ...
    public ResponseEntity<SimpleRestResponse<ActionLogRecordDto>> addComment(@PathVariable int recordId,
        ...
        ActionLogRecordDto result = this.getActivityStreamService()
                .addComment(commentRequest, (UserDetails) request.getSession().getAttribute("user"));
    ...
    public ResponseEntity<SimpleRestResponse<ActionLogRecordDto>> removeComment(@PathVariable int recordId, @PathVariable int commentId,
            HttpServletRequest request) throws JsonProcessingException {
        ActionLogRecordDto result = this.getActivityStreamService()
                .removeComment(recordId, commentId, (UserDetails) request.getSession().getAttribute("user"));
