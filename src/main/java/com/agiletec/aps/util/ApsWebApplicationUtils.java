...
public class ApsWebApplicationUtils {
    ...
    /**
     * Restituisce un servizio di sistema. Il seguente metodo è in uso ai tag jsp del sistema.
     *
     * @param serviceName Il nome del servizio richiesto.
    ...
    /**
     * Restituisce un bean di sistema. Il seguente metodo è in uso ai tag jsp del sistema.
     *
