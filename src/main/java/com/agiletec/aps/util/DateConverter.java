...
public class DateConverter {
    ...
    /**
     * Utility method. Parses the input string to a date object, given a valid pattern DATE_FORMAT. Return null if the string itself is
     * either null or empty (or if the format is invalid of course)
     *
