...
/**
 * Classe per la lettura e scrittura delle Properties da xml. Il formato dell'xml è:
 *
...
public class ApsPropertiesDOM {
    ...
    private static final String TAB_ELEMENT = "property";
    ...
    private ApsProperties extractProperties() {
        ...
        while (elementsIter.hasNext()) {
            Element currentElement = elementsIter.next();
