...
/**
 * Build the URL to call a functionality of a servlet defined within the system. This tag can use subtag ParameterTag to add url parameters.
 * The parameter 'path' must contain a path relative to the context of web-application (es.: /do/myAction or /WEB-INF/jsp/myJSP.jsp)
 *
