...
/**
 * Generates the URL to a portal page. The URL is either displayed or placed in a variable. The URL depends on the page attributes and the
 * given language otherwise the current values are used. Use the sub-tag "ParameterTag" to insert parameters in the query string.
 */
public class URLTag extends TagSupport implements IParameterParentTag {
    ...
    /**
     * Gets list of parameter names (comma separated) to exclude from repeating. By default, this attribute excludes only the password
     * parameter of the login form.
     *
    ...
    /**
     * Sets the list of parameter names (comma separated) to exclude from repeating. By default, this attribute excludes only the password
     * parameter of the login form.
     *
