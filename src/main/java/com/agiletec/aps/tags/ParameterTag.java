...
/**
 * This tag can be used to parameterise other tags.<br/> The parameter value can be added through the 'value' attribute or the body tag. The
 * parameters are added using the {@link IParameterParentTag#addParameter(String, String) addParamter} method. When you declare the param
 * tag, the value can be defined in either a value attribute or as text between the start and the ending of the tag.
 *
 * @author E.Santoboni
 */
