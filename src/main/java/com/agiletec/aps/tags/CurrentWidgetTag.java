...
/**
 * Returns informations about the showlet where the tag resides. The "param" attribute acceptes the following values: - "code" returns the
 * code of the associated showlet type (empty if none associated)<br/> - "title" returns the name of the associated showlet type (empty if
 * none associated)<br/> - "config" returns the value of the configuration parameter declared in the "configParam" attribute<br/> To obtain
 * information about a showlet placed in a frame other than the current, use the "frame" attribute.
 *
