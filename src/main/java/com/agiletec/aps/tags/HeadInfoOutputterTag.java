...
/**
 * Iterates over various information in HTML header displaying them. It retrieves data from a "HeadInfoContainer" object located in the
 * RequestContext. This tag works in conjunction with other sub-tag specific to the information type Please note that the body can contain
 * only a sub-tag, or information, at once.<br/> This tag must be used <b>only</b> in a page model.
 */
