...
public class PagerTagHelper {
    ...
    /**
     * Restituisce l'oggetto necessario per fornire gli elementi necessari a determinare l'item corrente.
     *
     ...
     * @param pagerIdFromFrame Determina se ricavare l'identificativo dall'id del frame dove è inserito il paginatore.
     * @param max Il numero massimo (specificato nel tag) di elementi per item. Nel caso che sia 0 (o non sia stato specificato nel tag) il
     * valore viene ricercato nei parametri di configurazione della showlet.
