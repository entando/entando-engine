...
/**
 * Toggle the visibility of the elements contained in body tag, depending on user permissions. The user authorizations are checked against
 * either the given permission or the specified group membership. Is possible to insert the result of the authorization check in a variable
 * placed in the page context.
 *
 * @author E.Santoboni
 */
public class CheckPermissionTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            boolean isAuthGr = isGroupSetted && (authManager.isAuthOnGroup(currentUser, this.getGroupName()) || authManager
                    .isAuthOnGroup(currentUser, Group.ADMINS_GROUP_NAME));
            boolean isAuthPerm = isPermissionSetted && (authManager.isAuthOnPermission(currentUser, this.getPermission()) || authManager
                    .isAuthOnPermission(currentUser, Permission.SUPERUSER));
    ...
    /**
     * Return the name of the variable where the result of the authorization checks is placed in form of an boolean value.
     *
    ...
    /**
     * Set the name of the variable where the result of the authorization checks is placed in form of an boolean value.
     *
