...
/**
 * Returns the requested information held by the current page bean. It is possible to ask for the title in the current language (param
 * value: "title") or the code (param: "code"). The title in the current language is returned if "param" is not specified
 *
 * @author E.Santoboni
 */
