...
public class NavigatorTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            INavigatorParser navigatorParser = (INavigatorParser) ApsWebApplicationUtils
                    .getBean(SystemConstants.NAVIGATOR_PARSER, this.pageContext);
    ...
    /**
     * Return the name of the page context variable where the data of target being iterated are made available
     *
    ...
    /**
     * Set the name of the page context variable where the data of target being iterated are made available
     *
