...
/**
 * Returns the information of the desired system parameter. Key of the desired system parameter, admitted values are:<br/> "startLang"
 * returns the code of start language of web browsing<br/> "defaultLang" returns the code of default language<br/> "currentLang" returns the
 * code of current language<br/> "langs" returns the list of the languages defined in the system<br/> "systemParam" returns the value of the
 * system parameter specified in the "paramName" attribute.
 *
...
public class InfoTag extends ExtendedTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            if ("startLang".equals(this._key)) {
                ...
                ILangManager langManager = (ILangManager) ApsWebApplicationUtils
                        .getBean(SystemConstants.LANGUAGE_MANAGER, this.pageContext);
                ...
                if (SystemConstants.PAR_APPL_BASE_URL.equals(this.getParamName())) {
                    ...
                    ConfigInterface confManager = (ConfigInterface) ApsWebApplicationUtils
                            .getBean(SystemConstants.BASE_CONFIG_MANAGER, this.pageContext);
    ...
    private Lang extractStartLang() {
        Lang startLang = null;
        ConfigInterface baseConfigManager = (ConfigInterface) ApsWebApplicationUtils
                .getBean(SystemConstants.BASE_CONFIG_MANAGER, this.pageContext);
    ...
    /**
     * Performs the generation of the label and make it available for immediate output or places it in a variable
     *
    ...
    /**
     * Return the name of the requested system parameter. This value is ignored when the value of the "key" attribute is other than
     * "systemParam"
     *
    ...
    /**
     * Set the name of the requested system parameter. This value is ignored when the value of the "key" attribute is other than
     * "systemParam"
     *
