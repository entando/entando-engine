...
/**
 * Pager tag. Please note that the advanced mode of the tag is used when the list to iterate over is huge. The "offset" attribute lets you
 * to control how the list is iterated by specifying the numeric value of each forward or backward step.
 *
 * @author E.Santoboni
 */
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            Collection collection =
                    (null != object && object instanceof SimpleSequence) ? ((SimpleSequence) object).toList() : (Collection) object;
            if (collection == null) {
