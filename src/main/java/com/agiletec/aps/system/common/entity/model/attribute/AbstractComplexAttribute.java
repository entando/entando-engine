...
/**
 * Abstract class used for the implementation of "Complex Attributes". Complex attributes are those constituted by the aggregation, in
 * different ways, of "Simple Attributes".
 *
 * @author E.Santoboni
 */
public abstract class AbstractComplexAttribute extends AbstractAttribute {
    ...
    /**
     * This method overrides the one of the abstract class so that it always returns false. This happens because Complex Attributes can
     * never be "searchable" by design.
     *
     ...
     */
    public abstract void setComplexAttributeConfig(Element attributeElement, Map<String, AttributeInterface> attrTypes)
