...
/**
 * Handler class that interprets the XML defining a Text Attribute which supports multiple languages ('Multi-language Text Attribute').
 *
 * @author E.Santoboni
 */
public class TextAttributeHandler extends AbstractMLAttributeHandler {
    ...
    /**
     * Do the starting attribute operations. This method is declared protected so that it can be later utilized by those Entity Attribute
     * that extend in turn the Text Attribute.
     *
    ...
    /**
     * Do the ending attribute operations. This method is declared protected so that it can be later utilized by those Entity Attribute that
     * extend in turn the Text Attribute.
     *
