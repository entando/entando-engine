...
/**
 * This class implements the 'tracer' for the Entando Attributes. This class is used, with the singles attributes, to trace the position
 * inside any 'complex' attributes. This class is involved during the update and validation process of the Attribute and, furthermore, it
 * guarantees the correct construction of the form in the content edit interface.
 *
 * @author E.Santoboni
 */
public class AttributeTracer {
    ...
    public AttributeTracer getMonoListElementTracer(int index) {
        AttributeTracer tracer = this.clone();
    ...
    /**
     * Return the name of the field related to the given attribute. The name is built considering the position of the attribute itself
    ...
    /**
     * Determine whether the attribute belongs to an element of a 'monolist' Attribute or not.
     *
     ...
     *
     * @param monoListElement true if the element belongs to a 'Monolist' Attribute, false otherwise.
     */
     ...
     *
     * @param listElement set true if the attribute belongs to a 'Multi-Language List' Attribute element, false otherwise.
     */
    ...
    /**
     * Return the language of the list when the current attribute is an element of a 'Multi-language List' attribute.
     *
    ...
    /**
     * Set the language of the list when the current attribute is an element belonging to a multi-language list attribute.
     *
    ...
    /**
     * Return the index of the position of the attribute within a multi-language list or a monolist.
     *
    ...
    /**
     * Setta l'indice relativo alla posizione dell'attributo elemento all'interno di una lista multilingua o di una monolista.
     *
