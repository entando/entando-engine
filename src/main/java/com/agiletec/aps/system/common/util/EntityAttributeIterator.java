...
/**
 * Un iteratore su tutti gli attributi elementari di un'entità. Gli attributi di tipo complesso non vengono restituiti da questo iteratore;
 * vengono restituiti invece gli attributi elementari presenti all'interno dei singoli attributi complessi. E' una classe helper da
 * utilizzare quando si devono eseguire operazioni su tutti gli attributi elementari di un'entità. L'entità è passata come parametro nel
 * costruttore. Il metodo remove non è supportato.
 *
...
public class EntityAttributeIterator implements Iterator {
    ...
    /**
     * Metodo dell'interfaccia Iterator, non utilizzabile. Lancia un'eccezione UnsupportedOperationException.
     *
