...
public abstract class AbstractListAttribute extends AbstractComplexAttribute
    ...
    public void setComplexAttributeConfig(Element attributeElement, Map<String, AttributeInterface> attrTypes) throws ApsSystemException {
        ...
        if (nestedTypeAttributeElements == null || nestedTypeAttributeElements.size() != 1) {
            throw new ApsSystemException(
                    "Wrong list attribute element detected: Wrong number of nested type in attribute list " + this.getName());
        }
        ...
        AttributeInterface nestedType = attrTypes.get(nestedTypeCode);
        if (nestedType == null) {
    ...
    */
    ...
    /**
     * Return the attribute to utilize as prototype for the creation of the elements to add to the list of attributes.
     *
    ...
    /**
     * Set up the attribute to utilize as prototype for the creation of the elements to add to the list of attributes.
     *
    ...
    /**
     * Return the string which identifies the type of the attributes which will be held in this class.
     *
    ...
    /**
     * This method overrides the method of the abstract class it derives from, because this kind of attribute can never be "indexable" and
     * so it always returns the constant 'INDEXING_TYPE_NONE', belonging to 'AttributeInterface', which declares it not searchable.
     * Declaring a complex attribute indexable will result in its constituting elements to be considered as such.
     *
    ...
    /**
     * This method overrides the method of the abstract class it derives from, because this kind of attribute can never be "searchable" and
     * so it always return a 'false' value.
     *
