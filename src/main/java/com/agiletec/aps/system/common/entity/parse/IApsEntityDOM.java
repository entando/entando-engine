...
public interface IApsEntityDOM {
    ...
    /**
     * DOM initialization. Method to invoke  when fields valorization is starting.
     */
    void init();
     ...
     */
    void setMainGroup(String group);
     ...
     */
    void addCategory(String categoryCode);
     ...
     */
    void addAttribute(Element attributeElem);
