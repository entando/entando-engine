...
/**
 * Base class for implementation of the System Services. Services are instantiated and initialized to the system boot or when prompted for
 * the re-loading the entire system.
 *
...
public abstract class AbstractService
    ...
    /**
     * Method to implement if you want to give fields of the service before the refresh. By default does nothing.
     */
    ...
    /**
     * Default implementation of destroy method. This method can be override if the service has to release objects before the destroy of the
     * service.
     */
    @Override
    public void destroy() {
