...
/**
 * This class represents an entity suitable for the rendering process. This class extends the HashMap object to make the access to the
 * entity objects easier.
 *
...
public class EntityWrapper implements Map {
    ...
    /**
     * Return the informations needed for the renderization. In presence of simple attributes, it return the attributes; for complex ones it
     * returns a structure suitable for the renderization - for instance, a list is returned to render a monolist.
     *
