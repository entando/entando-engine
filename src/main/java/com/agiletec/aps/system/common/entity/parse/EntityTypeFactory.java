...
/**
 * This class, which serves the ApsEntity managers, is used to obtain the Entity Types. This class is utilized by default in the Spring bean
 * configuration that defines the base {@link ApsEntityManager} Entity Manager
 *
 * @author E.Santoboni
 */
public class EntityTypeFactory implements IEntityTypeFactory {
    ...
    @Override
    public void updateEntityTypes(Map<String, IApsEntity> entityTypes, String configItemName, IEntityTypeDOM entityTypeDom)
