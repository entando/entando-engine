...
/**
 * Interface of the the entities class factory. This interface is used by the factory classes that serve the various ApsEntities managers.
 *
 * @author E.Santoboni
 */
public interface IEntityTypeFactory {

    List<SmallEntityType> extractSmallEntityTypes(String configItemName, IEntityTypeDOM entityTypeDom) throws ApsSystemException;

    /**
     * Return a prototype of an Entity Type by its code that the entity service is going to handle. The structure of the Entity Type is
     * obtained from a configuration XML.
     *
     ...
     */
    IApsEntity extractEntityType(String typeCode, Class entityClass, String configItemName,
     ...
     * @throws ApsSystemException If errors occurs during the parsing process of the XML.
     */
    Map<String, IApsEntity> extractEntityTypes(Class entityClass, String configItemName,
            IEntityTypeDOM entityTypeDom, String entityManagerName, IApsEntityDOM entityDom) throws ApsSystemException;
     ...
     * @param entityTypeDom The DOM class that parses the configuration XML.
     */
    void updateEntityTypes(Map<String, IApsEntity> entityTypes, String configItemName, IEntityTypeDOM entityTypeDom)
