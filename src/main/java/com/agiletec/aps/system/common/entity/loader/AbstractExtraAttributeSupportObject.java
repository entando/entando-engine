...
public abstract class AbstractExtraAttributeSupportObject implements ServletContextAware, Serializable {
    ...
    /**
     * Extract the xml with the definition of Attribute support object. The xml will be extracted from the file path in the instance param.
     *
    ...
    public void setEntityManagerDest(IEntityManager entityManagerDest) {
        String name = entityManagerDest.getName();
