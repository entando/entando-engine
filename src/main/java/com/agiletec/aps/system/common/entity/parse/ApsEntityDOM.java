...
/**
 * This class generates the XML of the single entity, and it is used by all those managers that manages ApsEntity elements. This class is
 * used by the managers that manage the ApsEntities; it is utilized by default in the Spring definition of the abstract service {@link
 * ApsEntityManager}; this definition can be substituted in the declaration of those services that, extending the 'ApsEntityManager'use a
 * custom DOM class to build the XML code that maps the structure of a new Entity Type. Such Entity Type must implement the 'IApsEntity'
 * interface.
 *
...
public class ApsEntityDOM implements IApsEntityDOM, Serializable {
    ...
    private static final String[] TAGS = {TAG_DESCR, TAG_GROUPS, TAG_CATEGORIES, TAG_ATTRIBUTES};
    /**
    ...
    /**
     * DOM initialization; this method must be invoked when starting to populate the fields.
     */
    @Override
    public void init() {
        this.buildDOM();
     ...
     *
     * @param attributeElem The element, which corresponds to an attribute, to add to the entity XML structure.
     */
    @Override
