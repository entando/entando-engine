...
public interface AttributeHandlerInterface extends Serializable {
     ...
     */
    Object getAttributeHandlerPrototype();

    /**
     * Extend the startAttribute of the dell'AttributeHandler, directly handling the XML tags of the current attribute.
     *
    ...
    /**
     * Extend the l'endAttribute of the dell'AttributeHandler, directly handling the XML tags of the current attribute
     *
     * @param qName The name of the current XML tag.
     * @param textBuffer The text read inside the XML tag.
     */
    void endAttribute(String qName, StringBuffer textBuffer);
     ...
     */
    boolean isEndAttribute(String qName);
     ...
     */
    void setCurrentAttr(AttributeInterface currentAttr);
