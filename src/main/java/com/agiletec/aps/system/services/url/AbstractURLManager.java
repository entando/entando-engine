...
/**
 * Servizio di creazione di URL alle risorse del sistema. Per ora è previsto solo l'URL da utilizzare come link ad una pagina del
 * portale.<br> Costituisce anche la factory per gli oggetti PageURL. La classe è astratta in quanto la mappatura tra url e risorse può
 * essere differente a seconda delle esigenze. Ad esempio, in un portale multilingua può essere utile introdurre il codice lingua come parte
...
public abstract class AbstractURLManager extends AbstractService implements IURLManager {
     ...
     * @return La query string; se la mappa passata è nulla o vuota restituisce una stringa vuota, se la mappa non è vuota la stringa
