...
/**
 * Servizio di configurazione. Carica da db e rende disponibile la configurazione. La configurazione è costituita da voci (items),
 * individuate da un nome, e da parametri, anch'essi individuati da un nome. I parametri sono stringhe semplici, le voci possono essere
 * testi XML complessi. In particolare, una delle voci contiene la configurazione dei parametri in forma di testo XML. L'insieme dei
 * parametri comprende anche le proprietà di inizializzazione, passate alla factory del contesto di sistema; i valori di queste possono
...
public class BaseConfigManager extends AbstractService implements ConfigInterface, ServletContextAware {
    ...
    /**
     * Restituisce il valore di una voce della tabella di sistema. Il valore può essere un XML complesso.
     *
    ...
    /**
     * Aggiorna un'item di configurazione nella mappa della configurazione degli item e nel db.
     *
    ...
    /**
     * Restituisce il valore di un parametro di configurazione. I parametri sono desunti dalla voce "params" della tabella di sistema.
     *
    ...
    protected void checkSecurityConfiguration(Properties mainProps) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Invalid value for Argon2 hashType '" + algoType + "'; the default value is '" + defaultAlgoType + "'", e);
        }
