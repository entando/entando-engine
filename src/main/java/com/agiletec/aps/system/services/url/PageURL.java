...
/**
 * Rappresenta un URL ad una pagina del sistema. Oggetti di questa classe devono avere un ciclo di vita limitato ad una richiesta; non
 * devono essere memorizzati in modo permanente.
 *
 * @author M.Diana
 */
public class PageURL {
    ...
    /**
     * Costruttore utilizzato dalla factory di questa classe (IURLManager). Non deve essere utilizzato direttamente.
     *
    ...
    /**
     * Imposta la lingua richiesta. L'effetto è equivalente alla chiamata setLangCode(lang.getCode()) .
     *
    ...
    /**
     * Imposta la pagina richiesta. L'effetto è equivalente alla chiamata setPageCode(page.getCode()) .
     *
    ...
    /**
     * Restituisce l'URL utilizzabile. La costruzione dell'URL è delegata all'implementazione della classe AbstractURLManager.
     *
