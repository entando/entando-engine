 ...
 * pagina cui è applicato.<br><br> Solo nel caso dell'operatore "Subtree" gli oggetti NavigatorTarget restituiti hanno associato un valore
 * significativo del livello nel sottoalbero; in tutti gli altri casi il livello ha valore zero.
 *
 * @author M.Diana
 */
public interface INavigatorParser {
     ...
     */
    List<NavigatorTarget> parseSpec(String spec, RequestContext reqCtx);
     ...
     * @return La lista di oggetti NavigatorTarget.
     */
    List<NavigatorTarget> parseSpec(String spec, IPage currentPage, UserDetails currentUser);

    String getSpec(List<NavigatorExpression> expressions);

    List<NavigatorExpression> getExpressions(String spec);
