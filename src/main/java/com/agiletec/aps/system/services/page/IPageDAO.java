...
public interface IPageDAO {
     ...
     */
    List<PageRecord> loadPageRecords();
     ...
     */
    void updatePosition(String pageDown, String pageUp);

    void updateWidgetPosition(String pageCode, Integer frameToMove, Integer destFrame);

    /**
     * Setta il widget (comprensiva della sua configurazione) nella pagina e nel frame specificato. Nel caso che la posizione specificata
     * sia già occupata, il widget corrente sarà sostituita da quella specificata.
     *
     ...
     */
    void joinWidget(IPage page, Widget widget, int pos);
     ...
     */
    void removeWidget(IPage page, int pos);
     ...
     */
    void movePage(IPage currentPage, IPage newParent);
    ...
    List<String> loadLastUpdatedPages(int size);
