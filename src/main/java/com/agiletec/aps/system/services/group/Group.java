...
public class Group extends AbstractAuthority implements Serializable {
    ...
    /**
     * Indica se il gruppo è definito localmente all'interno del db "serv" di Entando.
     *
     * @return true se è un gruppo locale di Entando, false se è un gruppo definito in un'altra base dati.
     */
