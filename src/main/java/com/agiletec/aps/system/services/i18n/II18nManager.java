...
public interface II18nManager {
    ...
    /**
     * Renders a label, according to a given key, in the desired language. If the label is empty or not translated, is rendered in the
     * default language. If the label is empty or not translated in the default language, the value is returned accordingly to keyIfEmpty
     * value:
     * <ul>
     ...
     */
    String renderLabel(String key, String renderingLang, boolean keyIfEmpty) throws ApsSystemException;
     ...
     * @param renderingLang The code of the rendering language.
     * @param keyIfEmpty If the label is empty or not exists, returns the label key
     * @param params The parameters to be replaced into the label. The parameters, in the label text, must be as ${param_name}
     * @return The value of the label, in the rendering language.
     */
    String renderLabel(String key, String renderingLang, boolean keyIfEmpty, Map<String, String> params) throws ApsSystemException;
     ...
     */
    String getLabel(String key, String langCode) throws ApsSystemException;

    ApsProperties getLabelGroup(String key) throws ApsSystemException;
     ...
     */
    void addLabelGroup(String key, ApsProperties labels) throws ApsSystemException;
     ...
     * @throws ApsSystemException In case of Exception.
     */
    void deleteLabelGroup(String key) throws ApsSystemException;
     ...
     * @throws ApsSystemException In case of Exception.
     */
    void updateLabelGroup(String key, ApsProperties labels) throws ApsSystemException;

    /**
     * Restituisce la lista di chiavi di gruppi di labels in base ai parametri segbalati.
     *
     ...
     */
    List<String> searchLabelsKey(String insertedText, boolean doSearchByKey,
