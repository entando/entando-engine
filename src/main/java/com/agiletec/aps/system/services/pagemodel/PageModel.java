...
/**
 * Representation of a page template. This object contains the description and the definition of "frames" available. The definition of the
 * page model is in the form of jsp or freemarker template. In the case of representation on jsp, the file name is equals then the model
 * code. The "frames" are page sections that can contains a "widget".
 */
...
public class PageModel implements Serializable {
    ...
    /**
     * Return the code of the plugin owner of page model. The field is null if the page model belong to Entando Core.
     *
