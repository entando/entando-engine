...
/**
 * Classe di supporto all'interpretazione dell'XML indicante le lingue del sistema. La classe viene utilizzata anche per l'interpretazione
 * dell'xml delle lingue "assegnabili" al sistema.
 *
 * @author E.Santoboni
 */
