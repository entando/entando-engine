...
/**
 * Oggetto di utilità per la configurazione dei widget navigatore. Ogni espressione in forma di stringa ha la forma:<br>
 ...
 * pagina cui è applicato.<br><br> Gli specificatori di pagina sono:<ul>
...
public class NavigatorExpression {
    ...
    /**
     * Identificativo specificatore pagina: pagina corrente.
     */
    public static final int SPEC_CURRENT_PAGE_ID = 1;
    public static final String SPEC_CURRENT_PAGE_CODE = "current";
    /**
     * Identificativo specificatore pagina: nodo di cui la pagina corrente è figlia.
     */
    public static final int SPEC_PARENT_PAGE_ID = 2;
    public static final String SPEC_PARENT_PAGE_CODE = "parent";
    /**
     * Identificativo specificatore pagina: nodo progenitore della pagina corrente a distanza n.
     */
    public static final int SPEC_SUPER_ID = 3;
    public static final String SPEC_SUPER_CODE = "super";
    /**
     * Identificativo specificatore pagina: nodo progenitore della pagina corrente a distanza n dalla pagina radice.
     */
    public static final int SPEC_ABS_ID = 4;
    public static final String SPEC_ABS_CODE = "abs";
    /**
     * Identificativo specificatore pagina: una pagina di cui viene specificato il codice.
     */
    public static final int SPEC_PAGE_ID = 5;
    public static final String SPEC_PAGE_CODE = "code";
    /**
     * Identificativo operatore: tutti i nodi figli della pagina cui è applicato.
     */
    public static final int OPERATOR_CHILDREN_ID = 1;
    public static final String OPERATOR_CHILDREN_CODE = "children";
    /**
     * Identificativo operatore: tutti i nodi del percorso dalla pagina radice alla pagina cui è applicato.
     */
    public static final int OPERATOR_PATH_ID = 2;
    public static final String OPERATOR_PATH_CODE = "path";
    /**
     * Identificativo operatore: sottoalbero a partire dalla pagina cui è applicato e fino a gli n livelli sottostanti.
     */
    ...
    /**
     * Costruttore interpretatore dei una espressione. Consente l'interpretazione della struttura della singola espressione (componente la
     * stringa che identifica la totalità delle pagine da erogare nel menù).
     *
    ...
    protected void createSpecSection(StringBuffer buffer) {
        ...
        switch (specId) {
            ...
            case NavigatorExpression.SPEC_ABS_ID:
                if (this.getSpecAbsLevel() < 0) {
                    throw new RuntimeException("level 'ABS' not specified");
                }
                buffer.append(SPEC_ABS_CODE).append("(").append(this.getSpecAbsLevel()).append(")");
                break;
            case NavigatorExpression.SPEC_SUPER_ID:
                if (this.getSpecSuperLevel() < 0) {
                    throw new RuntimeException(" Level 'SUPER' not specified");
                }
                buffer.append(SPEC_SUPER_CODE).append("(").append(this.getSpecSuperLevel()).append(")");
                break;
            case NavigatorExpression.SPEC_PAGE_ID:
                if (null == this.getSpecCode()) {
                    throw new RuntimeException("Page Code not specified");
                }
        ...
        if (operId > 0) {
            ...
            switch (operId) {
                ...
                case OPERATOR_SUBTREE_ID:
                    if (this.getOperatorSubtreeLevel() < 0) {
                        throw new RuntimeException("Livello Operatore 'SUBTREE' non Specificato");
                    }
