...
public class PageModelDOM {
    ...
    private static final String TAB_FRAME = "frame";
    private static final String ATTRIBUTE_POS = "pos";
    private static final String ATTRIBUTE_MAIN = "main";
    private static final String TAB_DESCR = "descr";
    private static final String TAB_DEFAULT_WIDGET = "defaultWidget";
    private static final String ATTRIBUTE_CODE = "code";
    private static final String TAB_PROPERTIES = "properties";
    private static final String TAB_PROPERTY = "property";
    private static final String ATTRIBUTE_KEY = "key";
    private static final String TAB_SKETCH = "sketch";
    ...
    /**
     * Constructor of the dom. This constructor has to be used for create a page model from xml.
     *
    ...
    private ApsProperties buildProperties(Element propertiesElement) {
        ...
        while (propertyElementsIter.hasNext()) {
            Element property = propertyElementsIter.next();
    ...
    /**
     * the framework behavior when, reading from db, no sketch info is found. this implementations do nothing
     */
