...
/**
 * Data Access Object delegate alla gestione delle le voci di configurazione. Opera sulla tabella "system".
 *
...
public class ConfigItemDAO extends AbstractDAO implements IConfigItemDAO {
    ...
    private static final String VERSION_ITEMS =
            "SELECT item, config FROM sysconfig WHERE version = ?";
    private static final String VERSION_ITEM =
