...
/**
 * Rappresenta il contesto relativo ad una richiesta del client. Contiene i riferimenti alla request, alla response, al contesto di sistema
...
public class RequestContext {
    ...
    /**
     * Imposta la mappa dei parametri extra e memorizza il riferimento al contesto del sistema.
     */
