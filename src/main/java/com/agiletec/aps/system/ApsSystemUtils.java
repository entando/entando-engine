...
public class ApsSystemUtils {
    ...
    public void init() throws Exception {
        ...
        RollingFileAppender fileAppender = configuration.getAppender(appenderName);
        if (null == fileAppender) {
            ...
            DeleteAction deleteAction = DeleteAction
                    .createDeleteAction(basePath, true, 1, false, null, pathConditions, null, configuration);
