...
public class TestCategoryManager extends BaseTestCase {
    ...
    public void testAddCategory() throws Throwable {
        ...
        try {
            ...
            assertTrue(Arrays.asList(extractedParent.getChildrenCodes())
                    .containsAll(Arrays.asList("general_cat1", cat.getCode(), "general_cat2", "general_cat3")));
        } catch (Throwable t) {
            throw t;
        } finally {
            ...
            assertTrue(Arrays.asList(extractedParent.getChildrenCodes())
                    .containsAll(Arrays.asList("general_cat1", "general_cat2", "general_cat3")));
        }
