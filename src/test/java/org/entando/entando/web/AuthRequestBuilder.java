...
/**
 * An instance of this class can be obtained calling the createAuthRequest() method from a controller test class. This builder can be used
 * for performing mocked HTTP requests using a valid authorization header. JSON is the default content type.
 *
 * Example:
