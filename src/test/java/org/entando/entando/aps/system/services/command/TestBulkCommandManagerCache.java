...
public class TestBulkCommandManagerCache extends TestCase /* BaseTestCase*/ {
    ...
    public void testClean() {
        for (int i = 0; i < 10; i++) {
            String name = "test" + i;
            FakeBulkCommand command = new FakeBulkCommand(
                    new BaseBulkCommandContext<String>(new ArrayList<String>(), new DefaultBulkCommandTracer<String>()));
        ...
        _bulkCommandManager.cleanCache();
