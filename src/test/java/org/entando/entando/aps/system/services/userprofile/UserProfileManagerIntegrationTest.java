...
public class UserProfileManagerIntegrationTest extends BaseTestCase {
    ...
    public void testSearchProfiles_2() throws Throwable {
        ...
        EntitySearchFilter fullnameRoleFilter2 = EntitySearchFilter
                .createRoleFilter(SystemConstants.USER_PROFILE_ATTRIBUTE_ROLE_FULL_NAME, "se", true);
        ...
        EntitySearchFilter fullnameRoleFilter3 = EntitySearchFilter
                .createRoleFilter(SystemConstants.USER_PROFILE_ATTRIBUTE_ROLE_FULL_NAME, "se", true);
